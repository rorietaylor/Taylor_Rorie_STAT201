...
final_min <- var_seconds %/% 60 
final_sec <- var_seconds %% 60
...
if(final_min == 1){
  minute_statement <- paste(final_min, "minute")
} else{
  minute_statement <- paste(final_min, "minutes")
}

if(final_sec == 1){
  second_statement <- paste(final_sec, "second.")
} else{
  second_statement <- paste(final_sec, "seconds.")
}

if(var_seconds == 1){
  print(paste(var_seconds, "second is", minute_statement, "and", second_statement))
} else{
  print(paste(var_seconds, "seconds is", minute_statement, "and", second_statement))
}
```
...
for (i in 1:var_integer){
  final_factorial <- final_factorial * i
}
...
```{r}
numeric_var <- 24
factors <- paste("The factors of", numeric_var, "are")
for(i in 1:numeric_var){
  if(i != 0){
    if(i != numeric_var){
      if(numeric_var%%i == 0){
        factors <- paste0(factors, " ", i, ",")
      }
    } else if(i == numeric_var){
        factors <- paste0(factors, " ", i, ".")
    }
  } 
}
...
if(is_prime == TRUE){
  print(paste(num_var, "is a prime number."))
} else{
  print(paste(num_var, "is not a prime number."))
}
```
...
while(squared <= num_value){
  if(num_square * num_square > num_value){
    squared <- num_square * num_square
    break
  } else{
...
print(paste0(num_square, " squared is ", squared, ", and is the first number whose square exceeds ", num_value, "."))
```
